...
<!-- scan-source-ref: release:v1.36.3+rke2r1 -->
<!-- scan-source-desc: release v1.36.3+rke2r1 -->
<!-- suse-cvss-rescore: enabled -->
> Go binary CVE severities reflect SUSE's CVSS re-scoring where it differs from Trivy.

## Images Scanned

- `docker.io/rancher/rke2-runtime:v1.36.3-rke2r1`
...
## Scan Results: `docker.io/rancher/rke2-runtime:v1.36.3-rke2r1`
