...
├─────────────────────┼────────────────┤          │        ├───────────────────┼───────────────┼──────────────────────────────────────────────────────────────┤
│ golang.org/x/net    │ CVE-2026-25681 │          │        │ v0.52.0           │ 0.55.0        │ Parsing arbitrary HTML which is then rendered using Render   │
│                     │                │          │        │                   │               │ can result ...                                               │
...
| Image | CRITICAL | HIGH |
| --- | ---: | ---: |
| `docker.io/rancher/rke2-runtime:v1.36.2-rc4-rke2r1` | 0 | 14 |
...
| `docker.io/rancher/hardened-dns-node-cache:1.26.8-build20260608` | 0 | 14 |
| `docker.io/rancher/hardened-k8s-metrics-server:v0.8.1-build20260604` | 0 | 14 |
